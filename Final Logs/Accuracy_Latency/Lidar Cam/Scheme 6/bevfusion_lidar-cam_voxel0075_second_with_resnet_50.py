...
db_sampler = dict(
    ...
    data_root='/media/xavier02/Sparkles1/nuscenes_robustness/',
    info_path=
    '/media/xavier02/Sparkles1/nuscenes_robustness/nuscenes_dbinfos_train.pkl',
    points_loader=dict(
        backend_args=None,
        coord_type='LIDAR',
        load_dim=5,
...
model = dict(
    ...
    img_backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/media/xavier02/xavier_ssd_500/mmdetection3d_source/mmdetection3d-main/projects/BEVFusion/configs/resnet50.pth',
            type='Pretrained'),
...
test_evaluator = dict(
    ann_file=
    '/media/xavier02/Sparkles1/nuscenes_robustness/nuscenes_infos_val.pkl',
    backend_args=None,
    data_root='/media/xavier02/Sparkles1/nuscenes_robustness/',
    metric='bbox',
    type='NuScenesMetric')
...
work_dir = './work_dirs/bevfusion_lidar-cam_voxel0075_second_with_resnet_50'
