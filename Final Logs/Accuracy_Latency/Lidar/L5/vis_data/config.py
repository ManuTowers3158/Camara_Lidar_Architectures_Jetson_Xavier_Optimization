...
data_root = '/media/xavier02/masterchef1/nuscenes/'
...
db_sampler = dict(
    ...
    data_root='/media/xavier02/masterchef1/nuscenes/',
    info_path='/media/xavier02/masterchef1/nuscenes/nuscenes_dbinfos_train.pkl',
    points_loader=dict(
        backend_args=None,
        coord_type='LIDAR',
        load_dim=5,
...
test_evaluator = dict(
    ann_file='/media/xavier02/masterchef1/nuscenes/nuscenes_infos_val.pkl',
    backend_args=None,
    data_root='/media/xavier02/masterchef1/nuscenes/',
    metric='bbox',
    type='NuScenesMetric')
            ...
            pipeline=[
                ...
                dict(
                    db_sampler=dict(
                        ...
                        data_root='/media/xavier02/masterchef1/nuscenes/',
                        info_path=
                        '/media/xavier02/masterchef1/nuscenes/nuscenes_dbinfos_train.pkl',
                        points_loader=dict(
                            backend_args=None,
                            coord_type='LIDAR',
                            load_dim=5,
...
work_dir = './work_dirs/bevfusion_lidar_voxel0075_5sweeps'
